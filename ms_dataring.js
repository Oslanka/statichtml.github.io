          ...
          if (brands) {
            for (var i in brands) {
              ...
              if (
                ...
                (i < 1 || /chromi/i.test(this.get(NAME)))
              ) {
...
(function () {
  ...
  var baseJsonInfo = {
      ...
      deviceResolution: JSON.stringify({
        screenWidth: window.screen.width,
        screenHeight: window.screen.height,
      }),
      deviceOsType: uap.getResult().os.name,
      deviceOsVer: uap.getResult().os.version,
      deviceBrowserVer: JSON.stringify(uap.getBrowser()),
    },
          ...
          debugger
            getIPs(function (ip) {
              ...
              document.addEventListener("mousedown", function (event) {
                ...
                let json = {
                  eventType: "mousedown",
                  prePageUrl: rooterBefore,
                  pageUrl: window.location.href,
                  domContent: element.outerHTML,
                };
                Object.assign(json, baseJsonInfo);
                uploadAction(json);
              });
  ...
  (window.msDataSDK = ms_data_ring),
    typeof window.msDataSDK == "undefined" && (window.msDataSDK = ms_data_ring);
